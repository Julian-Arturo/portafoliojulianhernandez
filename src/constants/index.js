...
const experiences = [
  {
    ...
    points: [
      "Contributing to the structural design of a scalable web and mobile application using atomic design principles.",
      "Collaborating with a multidisciplinary team under the Scrum methodology to deliver product features efficiently.",
      "Assisting in the implementation of a shared design system and supporting CI/CD deployment processes.",
      "Utilizing Flutter 3.x and Clean Architecture for robust mobile development.",
    ],
  },
  {
    ...
    points: [
      ...
      "Working with technologies like AWS, Firebase, GraphQL and Google Analytics.",
      "Developed scalable mobile solutions serving extensive user base.",
    ],
  },
  {
    ...
    points: [
      ...
      "Flutter with Dart, implementing MVVM, Firebase and Clean architecture.",
      "Direct work with stakeholders and founders ensuring product alignment.",
    ],
  },
  {
    title: "Mobile Developer",
    ...
    points: [
      ...
      "Collaborated on iOS and Flutter cross-platform development.",
    ],
  },
];
